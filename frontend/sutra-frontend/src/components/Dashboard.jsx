                ...
                <div key={idx} className="p-4 rounded-xl border border-slate-100 bg-slate-50">
                  ...
                  <div className="mt-2 flex items-baseline gap-1">
                    <span className="text-3xl font-black text-slate-900">
                      {item?.current_weight ? item.current_weight.toFixed(1) : '0.0'}
                    </span>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-500 font-mono">{order?.po_number || 'PENDING-ID'}</div>
                      </div>
                    </div>
                    <div className="font-bold text-slate-700 text-sm">{order?.quantity || 0}kg</div>
                  </div>
                ))
              ) : (
